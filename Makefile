...
p1: main.o MTFList.o orderedList.o
	g++ main.o MTFList.o orderedList.o -o p1

main.o: main.cpp MTFList.h
	g++ -c main.cpp

MTFList.o: MTFList.cpp MTFList.h
	g++ -c MTFList.cpp
...
submit:
	rm -f submit.zip
	zip submit.zip $(DRIVER_NAME).cpp MTFList.h MTFList.cpp orderedList.h orderedList.cpp Makefile
